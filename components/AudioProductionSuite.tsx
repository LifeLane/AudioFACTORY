...
export const AudioProductionSuite: React.FC<AudioProductionSuiteProps> = ({
  ...
  return (
    <div className="h-full overflow-y-auto custom-scrollbar p-3 sm:p-5 md:p-6 space-y-4 bg-[#F7F7F4]">
      
      {/* Live Collaboration & Studio Status Bar */}
      <LivePresenceBar />

      {/* Top Header Bento Strip */}
      <div className="border border-zinc-200 bg-white p-4 sm:p-5 rounded-xl shadow-2xs flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-lg sm:text-xl font-bold text-zinc-900 uppercase tracking-tight">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
          ...
          <div>
            <div className="flex items-center justify-between border-b border-zinc-100 pb-3 mb-3">
              <div className="flex items-center gap-2.5">
                <div className="w-8 h-8 rounded-lg bg-amber-100 text-amber-900 flex items-center justify-center font-mono font-bold">
                  <Music className="w-4 h-4" />
                </div>
                <div>
                  <h2 className="text-sm sm:text-base font-bold text-zinc-900 uppercase">
        ...
        <div className="lg:col-span-5 border border-zinc-200 bg-white p-4 sm:p-5 rounded-xl shadow-2xs flex flex-col justify-between space-y-4">
          <div>
            <div className="flex items-center justify-between border-b border-zinc-100 pb-3 mb-3">
              <div className="flex items-center gap-2.5">
                <div className="w-8 h-8 rounded-lg bg-rose-100 text-rose-700 flex items-center justify-center font-mono font-bold">
            ...
            <div className="mt-4 p-3.5 rounded-lg bg-zinc-50 border border-zinc-200 space-y-2.5">
              <div className="flex items-center justify-between text-xs font-mono text-zinc-700 font-bold">
                <span>Microphone Telemetry</span>
                <span className="text-emerald-600">Ready</span>
              </div>
              <div className="flex items-center gap-1 h-3 bg-zinc-200 rounded overflow-hidden px-1">
        ...
        <div className="lg:col-span-6 border border-zinc-200 bg-white p-4 sm:p-5 rounded-xl shadow-2xs space-y-3">
          <div className="flex items-center justify-between border-b border-zinc-100 pb-3">
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-lg bg-sky-100 text-sky-900 flex items-center justify-center font-mono font-bold">
            ...
            <span className="text-[10px] font-mono bg-sky-50 text-sky-800 border border-sky-200 px-2 py-0.5 rounded font-bold">
              1-Click
            </span>
          </div>
          ...
          <div className="grid grid-cols-2 gap-2.5">
            {QUICK_SFX_PRESETS.map((preset) => {
              ...
              return (
                <div
                  key={preset.id}
                  className="p-3 rounded-lg border border-zinc-200 bg-zinc-50 hover:bg-zinc-100/80 transition-all flex flex-col justify-between gap-2"
                >
                  ...
                  <div className="flex items-center gap-1.5 mt-1">
                    {hasGenerated ? (
                      ...
                      <button
                        ...
                        disabled={isGen}
                        className="flex-1 py-1 px-2 rounded bg-white hover:bg-zinc-200 border border-zinc-200 text-zinc-800 text-[11px] font-mono font-bold flex items-center justify-center gap-1 transition-colors"
                      >
                        {isGen ? (
        ...
        <div className="lg:col-span-6 border border-zinc-200 bg-white p-4 sm:p-5 rounded-xl shadow-2xs space-y-3">
          <div className="flex items-center justify-between border-b border-zinc-100 pb-3">
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-lg bg-emerald-100 text-emerald-900 flex items-center justify-center font-mono font-bold">
          ...
          <div className="space-y-3 pt-1">
            ...
            <div>
              <div className="flex justify-between text-xs font-mono text-zinc-700 mb-1">
                <span className="font-bold flex items-center gap-1.5">
                  <Mic className="w-3.5 h-3.5 text-rose-600" /> Spoken Dialogue Stem
                </span>
            ...
            <div>
              <div className="flex justify-between text-xs font-mono text-zinc-700 mb-1">
                <span className="font-bold flex items-center gap-1.5">
                  <Music className="w-3.5 h-3.5 text-amber-500" /> Background Soundscape Bed
                </span>
                <span>{bgmVolume}%</span>
              </div>
              <input
            ...
            <div className="p-2.5 rounded-lg bg-zinc-50 border border-zinc-200 flex items-center justify-between text-xs font-mono">
              <div className="flex items-center gap-2 text-zinc-700">
                <div className={`w-2 h-2 rounded-full ${activeBgmBuffer ? 'bg-emerald-500' : 'bg-zinc-300'}`} />
